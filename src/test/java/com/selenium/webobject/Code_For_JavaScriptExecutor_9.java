...
public class Code_For_JavaScriptExecutor_9 {
	...
	public void beforeTest() {
		...
		String projectPath = System.getProperty("user.dir"); // user. dir means current project path 
	...
	public void Code_For_JavaScriptExecutor_Test() throws Exception {
		...
		js.executeScript("arguments[0].value=''", w.findElement(By.cssSelector("input[ng-model='FirstName']")));
		js.executeScript("arguments[0].value='Jones'", w.findElement(By.cssSelector("input[ng-model='FirstName']")));
